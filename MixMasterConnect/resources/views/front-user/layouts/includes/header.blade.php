...
<head>
    ...
    <!-- color css -->
    <link href="../assets/css/color-4.css" rel="stylesheet" type="text/css">
    <link href="../assets/css/music-player.css" rel="stylesheet">
    <!--keyframe css-->
...
<body class="bg-black music" data-offset="50" data-spy="scroll" data-bs-target=".navbar">
    ...
    <!-- Nav Start-->
    <header class="music loding-header header-fixed">
        <div class="container">
            <div class="row">
                <div class="col">
                    <nav>
                        <a class="d-inline-block m-r-auto" href="music_layout.html">
                                        ...
                                        <li class="sub-menu"><a class="sub-menu-title" href="#">blog mix
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="blog-list-mix-right-sidebar.html">List mix with right
                                                        sidebar</a></li>
                                                <li><a href="blog-list-mix-no-sidebar.html">List mix with no
                                                        sidebar</a></li>
                                                ...
                                                <li><a href="blog-grid-mix-with-right-sidebar.html">grid mix with right
                                                        sidebar</a></li>
                                                <li><a href="blog-list-post-full-width-no-sidebar.html">grid mix with
                                                        no sidebar</a></li>
                                            </ul>
                                        </li>

                                        <li class="sub-menu"><a class="sub-menu-title" href="#">blog
                                                details</a>
                                            <ul>
                                                    ...
                                                    <div class="menu-container">
                                                        <ul class="menu-icon">
                                                            ...
                                                            <li><a href="boxshadow.html"><i
                                                                        class="icon-layers"></i>box shadow</a></li>
                                                    ...
                                                    <div class="menu-container">
                                                        <ul class="menu-icon">
                                                            <li><a href="event-schedule.html"><i
                                                                        class="icon-list"></i>event-schedule</a></li>
                                                    ...
                                                    <div class="menu-container">
                                                        <ul class="menu-icon">
                                                            <li><a href="progress.html"><i
                                                                        class="icon-bar-chart"></i>progress bar</a>
                                                            </li>
                                    ...
                                    <div class="mega-menu-container">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">portfolio</a>
                                                        <ul>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">portfolio
                                                            details</a>
                                                        <ul>
                                                            ...
                                                            <li><a href="portfolio-detail2.html">With Big
                                                                    breadcrumb</a>
                                                            </li>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">Trending
                                                            Layouts</a>
                                                        <ul>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">Masonry Style</a>
                                                        <ul>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">shop
                                                            categories</a>
                                                        <ul>
                                                            ...
                                                            <li><a href="category-page-rightsidebar(4-grid).html">right
                                                                    sidebar <i
                                                                        class="fa fa-magic color-animated"></i></a>
                                                            </li>
                                                ...
                                                <div class="col menu-container">
                                                    <a class="menu-head" data-bs-target=".demo2"
                                                        data-bs-toggle="collapse" href="#">shop categories</a>
                                                    <ul>
                                                ...
                                                <div class="col menu-container">
                                                    <a class="menu-head" data-bs-target=".demo2"
                                                        data-bs-toggle="collapse" href="#">product pages</a>
                                                    <ul>
                                                ...
                                                <div class="col ">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">shop pages</a>
                                                        <ul>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">header
                                                            options</a>
                                                        <ul>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">breadcrumb
                                                            option</a>
                                                        <ul>
                                                            ...
                                                            <li><a href="breadcrumb-parallex-background.html">parallex
                                                                    background</a></li>
                                                            <li><a href="breadcrumb-background.html">with
                                                                    background</a></li>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">footer
                                                            options</a>
                                                        <ul>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="menu-container">
                                                        <a class="menu-head" data-bs-target=".demo2"
                                                            data-bs-toggle="collapse" href="#">gallery types</a>
                                                        <ul>
